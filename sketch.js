...
function setup() {
  ...
  board1 = new Board(1000, 100, 50, 200);
  board2 = new Board( 1000,  350, 50, 200);
}
...
var board1Colission=Matter.SAT.collides(
  board1.body,
  playerArrows[i].body
)
...
if(board1Colission.collided||board2Collision.collided){
